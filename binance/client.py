...
class Client(object):
    ...
    def _get_earliest_valid_timestamp_futures(self, symbol, interval):
        """Get earliest valid open timestamp from Binance Futures
    ...
    def get_historical_futures_klines(self, symbol, interval, start_str, end_str=None,
                              limit=1500):
        ...
        # establish first available start timestamp
        first_valid_ts = self._get_earliest_valid_timestamp_futures(symbol, interval)
        start_ts = max(start_ts, first_valid_ts)
